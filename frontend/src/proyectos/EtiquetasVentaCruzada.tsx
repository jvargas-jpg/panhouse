...
// Campo "Venta cruzada" de SeccionMatrizIngreso.tsx: mismo patrón de
// chips que EtiquetasObjetivoComercial.tsx — texto libre, sin catálogo
// cerrado (el negocio dio ejemplos ilustrativos, "Feria, Conferencias,
// Impresión", no una lista fija de opciones).
export function EtiquetasVentaCruzada({ value, onChange }: { value: string[]; onChange: (etiquetas: string[]) => void }) {
  ...
  return (
    <div>
      <div className="flex gap-2">
        <input
          id="matriz-ingreso-venta-cruzada-entrada"
          type="text"
          placeholder="Ej. Feria, Conferencias, Impresión"
          value={entrada}
        ...
        <button
          ...
          aria-label="Agregar venta cruzada"
